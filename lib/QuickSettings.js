...
class QuickSettings {
    ...
    open() {
        ...
        for (let i = 0; i < pinnedSettings.length; i++) {
            ...
            console.log("assigned: " + anura.settings.get(pinnedSettings[i].registry));
        }
    ...
    async init() {
                    ...
                    for (let i = 0; i < pinnedSettings.length; i++) {
                        settingsElements.push(h("div", { class: "pinnedSetting", title: this.state.pinnedSettings[i]
                                ...
                                this.state.pinnedSettings =
                                    pinnedSettings;
                                console.log(this.state.pinnedSettings[i]);
                            ...
                            h("button", { class: [
                                    ...
                                    use(this.state.pinnedSettings[i].value, (value) => {
                                        console.log("Hold on let me cook: " +
                                            this.state
                                                .pinnedSettings[i].registry +
                                            " " +
                                            this.state
                                                .pinnedSettings[i].value);
                                        if (value)
                                            return "enabled";
                                        else
                                            return "disabled";
        ...
        (this.state.pinnedSettings = anura.settings.get("pinnedSettings") || [
            ...
            },
            {
                ...
                value: false,
                onChange: `anura.notifications.add({
                    title: "RainbowOS",
                    description: "You may need to reboot for this setting to change.",
            });`,
            },
            {
                registry: "lol_boot",
                ...
                description: "Do something funny when you boot up RainbowOS.",
                value: false
            },
        ]),
