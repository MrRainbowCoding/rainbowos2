    ...
    page = () => (h("div", { class: "aboutapp-container" },
        ...
        h("div", { class: "aboutapp-content" },
            ...
            $if(anura.settings.get("x86-disabled"), h("p", null,
                "RainbowOS x86 subsystem disabled. ",
                h("br", null),
                " Enable it in",
                " ",
                h("button", { "on:click": () => {
                ...
                "."), h("p", null, "How did you get the RainbowOS x86 subsystem enabled?")),
            h("br", null),
            h("br", null),
            h("p", null,
                ...
                h("button", { "on:click": async () => {
                        ...
                        browser.openTab("https://github.com/MercuryWorkshop/anuraOS/blob/main/LICENSE");
