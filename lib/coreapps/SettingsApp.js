...
const settingsCSS = css `
    ...
    *::-webkit-input-placeholder {
    ...
    div.container > div.sidebar > div:nth-child(2)
`;
            ...
            h("div", { "bind:this": use(this.state.settingsBody), class: "settings-body" },
                h("div", { id: "general", class: "general settings-category" },
                    ...
                    h("div", { class: "settings-group" },
                        ...
                        h(SettingSwitch, { title: "Transparent Shell Background", setting: "transparent-ashell" }),
                ...
                h("div", { id: "v86", class: "v86 settings-category" },
                    h("h3", { class: "settings-category-name" }, "RainbowOS x86"),
                    h("div", { class: "settings-group" }, this.state.show_x86_install ? (h("div", null,
                        h("button", { "on:click": async () => {
                            ...
                            }, class: "matter-button-contained", disabled: true}, "Install x86 Subsystem"),
                        ...
                        h("div", { class: "settings-item" },
                            ...
                            h("button", { class: "settings-button", "on:click": async () => {
                                    ...
                                    if (name && cmd) {
                                        ...
                                        console.log(anura.settings.get("user-xapps"));
                                        anura.notifications.add({
                ...
                h("div", { id: "reset", class: "settings-category" },
                    h("h3", { class: "settings-category-name" }, "Reset RainbowOS"),
                    h("div", { class: "settings-group" },
                        h("div", { class: "settings-item" },
                            h("span", { class: "settings-item-name" }, "Reset your RainbowOS install."),
                            h("button", { class: "matter-button-outlined", "on:click": async () => {
                                    const confirmation = await anura.dialog.confirm("Are you sure you want to powerwash RainbowOS? All of your data will be lost and will be unable to recover.");
                                    if (confirmation) {
                                        try {
